 ...
 *           from File 'Files/SVD/CMS32M67xx.svd',
...
/* =========================================  CMS32M67xx Specific Interrupt Numbers  ========================================== */
  ...
  ACMP_IRQn                 =   7,              /*!< 7  ACMP IRQ                                                               */
  ADC_IRQn                  =   8,              /*!< 8  ADC IRQ                                                                */
  SSP0_IRQn                 =   9,              /*!< 9  SPI IRQ                                                               */
  ...
  TM02_IRQn                 =  21,              /*!< 19 TM00 channel 2 interrupt request                                       */
  TM03_IRQn                 =  22,              /*!< 20 TM00 channel 3 interrupt request                                       */
...
#include "system_CMS32M67xx.h"                   /*!< CMS32M67xx System                                                          */
...
//  __IM  uint8_t   RESERVED9[4]; 
  ...
  __IOM uint8_t   PER10;                        /*!< (@ 0x00000810) Peripheral enable register 10                              */
  __IOM uint8_t   PER11;                        /*!< (@ 0x00000811) Peripheral enable register 11                              */
  __IOM uint8_t   PER12;                        /*!< (@ 0x00000812) Peripheral enable register 12                              */
  __IOM uint8_t   PER13;                        /*!< (@ 0x00000813) Peripheral enable register 13                              */
  __IM  uint16_t  RESERVED10[502];
	__IOM uint32_t  MCKC;                        /*!< (@ 0x00000C00) System clock select                                         */
	__IOM uint32_t  PLLCR;                        /*!< (@ 0x00000C04) PLL control register                                       */
	__IM  uint16_t  RESERVED3[2044];
...
typedef struct {                                /*!< (@ 0x40040000) PORT Structure                                             */
  ...
  __IOM uint8_t   PD2;                          /*!< (@ 0x00000042) Pull-down resistor option register 2                       */
	...
	__IOM uint8_t   PD4;                          /*!< (@ 0x00000044) Pull-down resistor option register 4                       */
	__IOM uint8_t   PD5;                          /*!< (@ 0x00000045) Pull-down resistor option register 5                       */
  __IM  uint8_t   RESERVED3[10];
  ...
  __IOM uint8_t   PMC2;                         /*!< (@ 0x00000062) Port mode control register 2                               */
	...
	__IOM uint8_t   PMC4;                         /*!< (@ 0x00000064) Port mode control register 4                               */
	__IOM uint8_t   PMC5;                         /*!< (@ 0x00000065) Port mode control register 5                               */
  __IM  uint8_t   RESERVED5[10];
  ...
  __IOM uint8_t   PSET2;                        /*!< (@ 0x00000072) Port set register 2                                        */
	__IOM uint8_t   PSET3;                        /*!< (@ 0x00000073) Port set register 3                                        */
	__IOM uint8_t   PSET4;                        /*!< (@ 0x00000074) Port set register 4                                        */
	__IOM uint8_t   PSET5;                        /*!< (@ 0x00000075) Port set register 5                                        */
  ...
  __IOM uint8_t   PCLR2;                        /*!< (@ 0x00000082) Port clear register 2                                      */
	__IOM uint8_t   PCLR3;                        /*!< (@ 0x00000083) Port clear register 3                                      */
	__IOM uint8_t   PCLR4;                        /*!< (@ 0x00000084) Port clear register 4                                      */
	__IOM uint8_t   PCLR5;                        /*!< (@ 0x00000085) Port clear register 5                                      */
  __IM  uint8_t   RESERVED7[13];
...
//  __IOM uint8_t   PREAD2;                       /*!< (@ 0x00000092) Port read register 2                                       */
  ...
  __IM  uint8_t   RESERVED23[1];
	__IOM uint8_t   P17CFG;                       /*!< (@ 0x0000081D) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED35[1];
...
//  __IOM uint8_t   P27CFG;                       /*!< (@ 0x0000082E) Alterate Output Function configuration register            */
	...
	__IOM uint8_t   P30CFG;                       /*!< (@ 0x00000830) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED36;
	__IOM uint8_t   P31CFG;                       /*!< (@ 0x00000832) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED38;
	__IOM uint8_t   P32CFG;                       /*!< (@ 0x00000834) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED39;
	__IOM uint8_t   P33CFG;                       /*!< (@ 0x00000836) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED40;
	__IOM uint8_t   P34CFG;                       /*!< (@ 0x00000838) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED41;
	__IOM uint8_t   P35CFG;                       /*!< (@ 0x0000083A) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED42;
	__IOM uint8_t   P36CFG;                       /*!< (@ 0x0000083C) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED43;
	__IOM uint8_t   P37CFG;                       /*!< (@ 0x0000083E) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED44;
	__IOM uint8_t   P40CFG;                       /*!< (@ 0x00000840) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED52;
	__IOM uint8_t   P41CFG;                       /*!< (@ 0x00000842) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED45;
	__IOM uint8_t   P42CFG;                       /*!< (@ 0x00000844) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED46;
	__IOM uint8_t   P43CFG;                       /*!< (@ 0x00000846) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED47;
	__IOM uint8_t   P44CFG;                       /*!< (@ 0x00000848) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED48;
	__IOM uint8_t   P45CFG;                       /*!< (@ 0x0000084A) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED49;
	__IOM uint8_t   P46CFG;                       /*!< (@ 0x0000084C) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED50;
	__IOM uint8_t   P47CFG;                       /*!< (@ 0x0000084E) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED51;
	__IOM uint8_t   P50CFG;                       /*!< (@ 0x00000850) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED53;
	__IOM uint8_t   P51CFG;                       /*!< (@ 0x00000852) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED54;
	__IOM uint8_t   P52CFG;                       /*!< (@ 0x00000854) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED55;
	__IOM uint8_t   P53CFG;                       /*!< (@ 0x00000856) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED56;
	__IOM uint8_t   P54CFG;                       /*!< (@ 0x00000858) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED57;
	__IOM uint8_t   P55CFG;                       /*!< (@ 0x0000085A) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED58;
	__IOM uint8_t   P56CFG;                       /*!< (@ 0x0000085C) Alterate Output Function configuration register            */
  __IM  uint8_t   RESERVED59;
	__IOM uint8_t   P57CFG;                       /*!< (@ 0x0000085E) Alterate Output Function configuration register            */
  ...
  __IOM uint8_t   UART0RXDCFG;                   /*!< (@ 0x00000868) UART0RXD alternate function pin configuration
                                                                    register                                                   */
  ...
  __IOM uint8_t   CCP1BINCFG;                   /*!< (@ 0x0000086D) CCP1BIN alternate function pin configuration
                                                                    register                                                   */
	__IOM uint8_t   UART1RXDCFG;                   /*!< (@ 0x0000086E) UART1RXD alternate function pin configuration
                                                                    register                                                   */	
  __IOM uint8_t   HALL0CFG;                     /*!< (@ 0x0000086F) HALL0 alternate function pin configuration register        */	
	__IOM uint8_t   HALL1CFG;                     /*!< (@ 0x00000870) HALL1 alternate function pin configuration register        */
	__IOM uint8_t   HALL2CFG;                     /*!< (@ 0x00000871) HALL2 alternate function pin configuration register        */
  __IM  uint8_t   RESERVED32[2];
  __IOM uint8_t   P0TTLCFG;                     /*!< (@ 0x00000874) Port 0 TTL input select register                           */
...
typedef struct {                                /*!< (@ 0x40020404) WDT Structure                                              */
  ...
  __IOM uint8_t   WDTE;                         /*!< (@ 0x00001001) Watchdog timer enable register                             */
...
typedef struct {                                /*!< (@ 0x40064200) EPWM Structure                                             */
  ...
  __IOM uint32_t  CON3;                         /*!< (@ 0x00000010) CON3 Description                                           */
	__IOM uint32_t  CON4;                         /*!< (@ 0x00000014) CON4 Description                                           */
  __IOM uint32_t  PERIOD[8];                      /*!< (@ 0x00000018) PERIOD0 Description                                        */
...
//  __IOM uint32_t  PERIOD5;                      /*!< (@ 0x00000028) PERIOD5 Description                                        */
  __IOM uint32_t  CMPDAT[8];                      /*!< (@ 0x00000038) CMPDAT0 Description                                        */
...
//  __IOM uint32_t  CMPDAT5;                      /*!< (@ 0x00000040) CMPDAT5 Description                                        */
	__IOM uint32_t  POREMAP_EN;                      /*!< (@ 0x00000058) POREMAP Description                                        */
  __IOM uint32_t  POREMAP;                      /*!< (@ 0x0000005C) POREMAP Description                                        */
  __IOM uint32_t  POEN;                         /*!< (@ 0x00000060) POEN Description                                           */
  __IOM uint32_t  BRKCTL;                       /*!< (@ 0x00000064) BRKCTL Description                                         */
//  __IOM uint32_t  DTCTL;                        /*!< (@ 0x00000050) DTCTL Description                                          */
  __IOM uint32_t  MASK;                         /*!< (@ 0x00000068) MASK Description                                           */
  __IOM uint32_t  MASKNXT;                      /*!< (@ 0x0000006C) MASKNXT Description                                        */
  __IOM uint32_t  CMPTGD[2];                    /*!< (@ 0x00000070) CMPTGD0 Description                                        */
//  __IOM uint32_t  CMPTGD1;                      /*!< (@ 0x00000060) CMPTGD1 Description                                        */
  __IOM uint32_t  IMSC;                         /*!< (@ 0x00000078) IMSC Description                                           */
	__IOM uint32_t  IMSC2;                        /*!< (@ 0x0000007C) IMSC Description                                           */
  __IM  uint32_t  RIS;                          /*!< (@ 0x00000080) RIS Description                                            */
	__IM  uint32_t  RIS2;                         /*!< (@ 0x00000084) RIS Description                                            */
  __IM  uint32_t  MIS;                          /*!< (@ 0x00000088) MIS Description                                            */
	__IM  uint32_t  MIS2;                          /*!< (@ 0x0000008C) MIS Description                                            */
  __OM  uint32_t  ICLR;                         /*!< (@ 0x00000090) ICLR Description                                           */
	__OM  uint32_t  ICLR2;                        /*!< (@ 0x00000094) ICLR Description                                           */
  __IOM uint32_t  IFA;                          /*!< (@ 0x00000098) IFA Description                                            */
  __IOM uint32_t  LOCK;                         /*!< (@ 0x0000009C) LOCK Description                                           */
	__IOM uint32_t  BRKRDT;                       /*!< (@ 0x000000A0) LOCK Description                                           */	
	__IOM uint32_t  DTCTL01;                      /*!< (@ 0x000000A4) LOCK Description                                           */
	__IOM uint32_t  DTCTL23;                      /*!< (@ 0x000000A8) LOCK Description                                           */
	__IOM uint32_t  DTCTL45;                      /*!< (@ 0x000000AC) LOCK Description                                           */
	__IOM uint32_t  DTCTL67;                      /*!< (@ 0x000000B0) LOCK Description                                           */
...
typedef struct {                                /*!< (@ 0x40064300) CCP Structure                                              */
  ...
  __IOM uint32_t  CAPCON;                    /*!< (@ 0x00000058) CAPCON Description                                         */
	__IOM uint32_t  CAPCON2;                   /*!< (@ 0x0000005C) CAPCON Description                                         */
	__IOM uint32_t  CAPCON3;                   /*!< (@ 0x00000060) CAPCON Description                                         */
  __IOM uint32_t  CAPCHS;                       /*!< (@ 0x00000064) CAPCHS Description                                         */
  __IOM uint32_t  CAP0DAT0;                     /*!< (@ 0x00000068) CAP0DAT0 Description                                       */
  __IOM uint32_t  CAP1DAT0;                     /*!< (@ 0x0000006C) CAP1DAT0 Description                                       */
  __IOM uint32_t  CAP2DAT0;                     /*!< (@ 0x00000070) CAP2DAT0 Description                                       */
  __IOM uint32_t  CAP3DAT0;                     /*!< (@ 0x00000074) CAP3DAT0 Description                                       */
	__IOM uint32_t  CAPDUTY;                     /*!< (@ 0x00000078) CAP3DAT0 Description                                       */
...
//typedef struct {                                /*!< (@ 0x40041A30) I2C0 Structure                                             */
...
typedef struct {                                /*!< (@ 0x40041A30) I2C0 Structure                                             */
  __IOM uint8_t  IICCTL0;                    /*!< (@ 0x00000000) I2CCONSET Description                                      */
  __IOM  uint8_t  IICCTL1;                    /*!< (@ 0x00000001) I2CCONCLR Description                                      */
  __IOM  uint8_t  IICWL;                      /*!< (@ 0x00000002) I2CSTAT Description                                        */
  __IOM uint8_t  IICWH;                      /*!< (@ 0x00000003) I2CDAT Description                                         */
	__IOM uint8_t   SVA0;                         /*!< (@ 0x00000004) Slave address register 0                                   */
  __IOM uint8_t  RESERVED0[283];                  /*!< (@ 0x00000010) I2CCLK Description                                         */
	__IOM uint8_t   IICA0;                        /*!< (@ 0x00000120) IICA shift register 0                                      */
  __IM uint8_t  IICS;                       /*!< (@ 0x00000121) I2CADR0 Description                                        */
  __IOM uint8_t  IICF;                       /*!< (@ 0x00000122) I2CADM0 Description                                        */
} I2C0_Type,I2C_T;   
...
typedef struct {                                /*!< (@ 0x40068000) ADC Structure                                              */
  ...
  __IOM uint32_t  CHPTG1;                    /*!< (@ 0x00000038) ADCCHPTG1 Description                                      */
	__IOM uint32_t  CHPIFTG;                    /*!< (@ 0x0000003C) ADCCHPTG1 Description                                      */
	__IOM uint32_t  CHZIFTG;                    /*!< (@ 0x00000040) ADCCHPTG1 Description                                      */
	__IM  uint32_t  RESERVED0[1];
	__IOM uint32_t  TEST;                      /*!< (@ 0x00000048) ADCCHPTG1 Description                                      */
	__IM  uint32_t  RESERVED[1];
	__IOM uint32_t  RESULT;                    /*!< (@ 0x00000050) ADCCHPTG1 Description                                      */
...
//  __IM  uint32_t  DATA22;                    /*!< (@ 0x000000D8) ADCDATA22 Description                                      */
  __IM  uint32_t  DATA[27];                    /*!< (@ 0x000000DC) ADCDATA23 Description                                      */
} ADC_Type;        
...
typedef struct {                                /*!< (@ 0x40068340) ADCLDO Structure                                           */
  __IOM uint32_t  CON0;                         /*!< (@ 0x00000000) CON0 Description                                           */
	__IOM uint32_t  TRIM;                         /*!< (@ 0x00000004) CON0 Description                                           */
  __IM  uint32_t  RESERVED[1];
...
typedef struct {                                /*!< (@ 0x40064480) DIVSQRT Structure                                          */
...
typedef struct {                                /*!< (@ 0x400644C0) DIVSQRT Structure                                          */
  __IOM uint32_t  CON;                          /*!< (@ 0x00000000) CON0 Description                                           */
  __IOM uint32_t  ALUA;                         /*!< (@ 0x00000004) ALUA Description                                           */
  __IOM uint32_t  ALUB;                         /*!< (@ 0x00000008) ALUB Description                                           */
  __IOM uint32_t  RES0;                         /*!< (@ 0x0000000C) RES0 Description                                           */
...
typedef struct {                                /*!< (@ 0x40068300) PGA0 Structure                                             */
  __IOM uint32_t  PGA0CON0;                     /*!< (@ 0x00000000) CON0 Description                                           */
	__IOM uint32_t  PGANCON0;                     /*!< (@ 0x00000004) CON1 Description                                           */
  __IOM uint32_t  PGANCON1;                     /*!< (@ 0x00000008) CON1 Description                                           */
  __IOM uint32_t  PGANSW;                     	/*!< (@ 0x0000000C) LOCK Description                                           */
	__IOM uint32_t  PGALOCK;                     /*!< (@ 0x00000010) CON1 Description                                           */
...
typedef struct {                                /*!< (@ 0x40068200) ACMP Structure                                             */
  ...
  __IOM uint32_t  CVECON;                       /*!< (@ 0x00000010) CVECON Description                                         */
  ...
  __OM  uint32_t  ICLR;                         /*!< (@ 0x00000020) ICLR Description                                           */ 
	__OM  uint32_t  ACMPOW;                       /*!< (@ 0x00000024) ICLR Description                                           */
  __IOM uint32_t  LOCK;                         /*!< (@ 0x00000028) LOCK Description                                           */
...
/* =======================================================  IICCTL00  ======================================================== */
#define I2C_IICCTL00_SPT_Pos             (0UL)                     /*!< IICA IICCTL00: SPT (Bit 0)                            */
#define I2C_IICCTL00_SPT_Msk             (0x1UL)                   /*!< IICA IICCTL00: SPT (Bitfield-Mask: 0x01)              */
#define I2C_IICCTL00_STT_Pos             (1UL)                     /*!< IICA IICCTL00: STT (Bit 1)                            */
#define I2C_IICCTL00_STT_Msk             (0x2UL)                   /*!< IICA IICCTL00: STT (Bitfield-Mask: 0x01)              */
#define I2C_IICCTL00_ACKE_Pos            (2UL)                     /*!< IICA IICCTL00: ACKE (Bit 2)                           */
#define I2C_IICCTL00_ACKE_Msk            (0x4UL)                   /*!< IICA IICCTL00: ACKE (Bitfield-Mask: 0x01)             */
#define I2C_IICCTL00_WTIM_Pos            (3UL)                     /*!< IICA IICCTL00: WTIM (Bit 3)                           */
#define I2C_IICCTL00_WTIM_Msk            (0x8UL)                   /*!< IICA IICCTL00: WTIM (Bitfield-Mask: 0x01)             */
#define I2C_IICCTL00_SPIE_Pos            (4UL)                     /*!< IICA IICCTL00: SPIE (Bit 4)                           */
#define I2C_IICCTL00_SPIE_Msk            (0x10UL)                  /*!< IICA IICCTL00: SPIE (Bitfield-Mask: 0x01)             */
#define I2C_IICCTL00_WREL_Pos            (5UL)                     /*!< IICA IICCTL00: WREL (Bit 5)                           */
#define I2C_IICCTL00_WREL_Msk            (0x20UL)                  /*!< IICA IICCTL00: WREL (Bitfield-Mask: 0x01)             */
#define I2C_IICCTL00_LREL_Pos            (6UL)                     /*!< IICA IICCTL00: LREL (Bit 6)                           */
#define I2C_IICCTL00_LREL_Msk            (0x40UL)                  /*!< IICA IICCTL00: LREL (Bitfield-Mask: 0x01)             */
#define I2C_IICCTL00_IICE_Pos            (7UL)                     /*!< IICA IICCTL00: IICE (Bit 7)                           */
#define I2C_IICCTL00_IICE_Msk            (0x80UL)                  /*!< IICA IICCTL00: IICE (Bitfield-Mask: 0x01)             */
/* =======================================================  IICCTL01  ======================================================== */
#define I2C_IICCTL01_PRS_Pos             (0UL)                     /*!< IICA IICCTL01: PRS (Bit 0)                            */
#define I2C_IICCTL01_PRS_Msk             (0x1UL)                   /*!< IICA IICCTL01: PRS (Bitfield-Mask: 0x01)              */
#define I2C_IICCTL01_DFC_Pos             (2UL)                     /*!< IICA IICCTL01: DFC (Bit 2)                            */
#define I2C_IICCTL01_DFC_Msk             (0x4UL)                   /*!< IICA IICCTL01: DFC (Bitfield-Mask: 0x01)              */
#define I2C_IICCTL01_SMC_Pos             (3UL)                     /*!< IICA IICCTL01: SMC (Bit 3)                            */
#define I2C_IICCTL01_SMC_Msk             (0x8UL)                   /*!< IICA IICCTL01: SMC (Bitfield-Mask: 0x01)              */
#define I2C_IICCTL01_DAD_Pos             (4UL)                     /*!< IICA IICCTL01: DAD (Bit 4)                            */
#define I2C_IICCTL01_DAD_Msk             (0x10UL)                  /*!< IICA IICCTL01: DAD (Bitfield-Mask: 0x01)              */
#define I2C_IICCTL01_CLD_Pos             (5UL)                     /*!< IICA IICCTL01: CLD (Bit 5)                            */
#define I2C_IICCTL01_CLD_Msk             (0x20UL)                  /*!< IICA IICCTL01: CLD (Bitfield-Mask: 0x01)              */
#define I2C_IICCTL01_WUP_Pos             (7UL)                     /*!< IICA IICCTL01: WUP (Bit 7)                            */
#define I2C_IICCTL01_WUP_Msk             (0x80UL)                  /*!< IICA IICCTL01: WUP (Bitfield-Mask: 0x01)              */
/* ========================================================  IICWL0  ========================================================= */
/* ========================================================  IICWH0  ========================================================= */
/* =========================================================  SVA0  ========================================================== */
/* =========================================================  IICA0  ========================================================= */
/* =========================================================  IICS0  ========================================================= */
#define I2C_IICS0_MSTS_Pos               (7UL)                     /*!< IICA IICS0: MSTS (Bit 7)                              */
#define I2C_IICS0_MSTS_Msk               (0x80UL)                  /*!< IICA IICS0: MSTS (Bitfield-Mask: 0x01)                */
#define I2C_IICS0_ALD_Pos                (6UL)                     /*!< IICA IICS0: ALD (Bit 6)                               */
#define I2C_IICS0_ALD_Msk                (0x40UL)                  /*!< IICA IICS0: ALD (Bitfield-Mask: 0x01)                 */
#define I2C_IICS0_EXC_Pos                (5UL)                     /*!< IICA IICS0: EXC (Bit 5)                               */
#define I2C_IICS0_EXC_Msk                (0x20UL)                  /*!< IICA IICS0: EXC (Bitfield-Mask: 0x01)                 */
#define I2C_IICS0_COI_Pos                (4UL)                     /*!< IICA IICS0: COI (Bit 4)                               */
#define I2C_IICS0_COI_Msk                (0x10UL)                  /*!< IICA IICS0: COI (Bitfield-Mask: 0x01)                 */
#define I2C_IICS0_TRC_Pos                (3UL)                     /*!< IICA IICS0: TRC (Bit 3)                               */
#define I2C_IICS0_TRC_Msk                (0x8UL)                   /*!< IICA IICS0: TRC (Bitfield-Mask: 0x01)                 */
#define I2C_IICS0_ACKD_Pos               (2UL)                     /*!< IICA IICS0: ACKD (Bit 2)                              */
#define I2C_IICS0_ACKD_Msk               (0x4UL)                   /*!< IICA IICS0: ACKD (Bitfield-Mask: 0x01)                */
#define I2C_IICS0_STD_Pos                (1UL)                     /*!< IICA IICS0: STD (Bit 1)                               */
#define I2C_IICS0_STD_Msk                (0x2UL)                   /*!< IICA IICS0: STD (Bitfield-Mask: 0x01)                 */
#define I2C_IICS0_SPD_Pos                (0UL)                     /*!< IICA IICS0: SPD (Bit 0)                               */
#define I2C_IICS0_SPD_Msk                (0x1UL)                   /*!< IICA IICS0: SPD (Bitfield-Mask: 0x01)                 */
/* =========================================================  IICF0  ========================================================= */
#define I2C_IICF0_STCF_Pos               (7UL)                     /*!< IICA IICF0: STCF (Bit 7)                              */
#define I2C_IICF0_STCF_Msk               (0x80UL)                  /*!< IICA IICF0: STCF (Bitfield-Mask: 0x01)                */
#define I2C_IICF0_IICBSY_Pos             (6UL)                     /*!< IICA IICF0: IICBSY (Bit 6)                            */
#define I2C_IICF0_IICBSY_Msk             (0x40UL)                  /*!< IICA IICF0: IICBSY (Bitfield-Mask: 0x01)              */
#define I2C_IICF0_STCEN_Pos              (1UL)                     /*!< IICA IICF0: STCEN (Bit 1)                             */
#define I2C_IICF0_STCEN_Msk              (0x2UL)                   /*!< IICA IICF0: STCEN (Bitfield-Mask: 0x01)               */
#define I2C_IICF0_IICRSV_Pos             (0UL)                     /*!< IICA IICF0: IICRSV (Bit 0)                            */
#define I2C_IICF0_IICRSV_Msk             (0x1UL)                   /*!< IICA IICF0: IICRSV (Bitfield-Mask: 0x01)              */
...
//  __IOM uint32_t  FLNVSCNT;                     /*!< (@ 0x00000018) Flash address setup time (Tnvs) control register           */
  ...
  __IM  uint32_t  RESERVED[122];
	__IOM uint32_t  FLRCELL;                       /*!< (@ 0x0000020C) Flash protect control register                             */
...
typedef struct {                                /*!< (@ 0x40021810) FMC Structure                                              */
  ...
  __IM  uint8_t   RESERVED1;
	__IOM uint16_t  PGCRCL;                        /*!< (@ 0x00000002) Flash CRC result low                          */
//	__IOM uint16_t  PGCRCH;                        /*!< (@ 0x00000004) Flash CRC result high                         */
} FMCRC_Type; 
...
typedef struct {                                /*!< (@ 0x400432FA) CRC Structure                                              */
  __IOM uint16_t   CRCD;                        /*!< (@ 0x00000000) CRC input register                                         */ 
	__IM  uint8_t   RESERVED1[176];
	__IOM uint8_t  CRCIN;                         /*!< (@ 0x000003AC) CRC data register                                          */
...
typedef struct {                                /*!< (@ 0x20000000) DMAVEC Structure                                           */
  ...
  __IOM DMAVEC_CTRL_Type CTRL[8];              /*!< (@ 0x00000010) DMA control data area                                      */
...
typedef struct {                                /*!< (@ 0x40064500) WDT Structure                                              */
  __IOM  uint32_t   CFG;													/*!< (@ 0x00000000) HALL config register                      */
  __IOM uint32_t   INFO;                        /*!< (@ 0x00000004) HAL information register              */
  __IOM uint32_t   CLRF;                        /*!< (@ 0x00000008) HALL interrupt flag clear register                             */
  __IOM  uint32_t   WIDTH;												/*!< (@ 0x0000000C) HALL width register                             */
  __IOM uint32_t   TH;                          /*!< (@ 0x00000010) HALL count limit register                             */
	__IOM uint32_t   CNT;                         /*!< (@ 0x000000014) HALL counter                             */	
	__IOM uint32_t   LOCK;                        /*!< (@ 0x000000018) HALL write enable register                            */
} HALL_Type;                                    /*!< Size = 3070 (0xbfe)                                                       */
...
typedef struct {                                /*!< (@ 0x40005000UL) DMA Structure                                              */
  __IOM  uint8_t   DMAEN0;													/*!< (@ 0x00000000) HALL config register                      */
	__IM  uint8_t  RESERVED[7];
  __IOM uint32_t   DMABAR;                        /*!< (@ 0x00000008) HAL information register              */
...
typedef struct {                                /*!< (@ 0x40020D00UL) DMA Structure                                              */
  __IOM uint32_t   DMATGS;                        /*!< (@ 0x00000000) HALL interrupt flag clear register                             */
  __IOM uint32_t   TGSEN0;												/*!< (@ 0x00000004) HALL width register                             */
  __IOM uint32_t   TGSEN1;                          /*!< (@ 0x0000008) HALL count limit register                             */
	__IOM uint32_t   TGSEN2;                         /*!< (@ 0x0000000C) HALL counter                             */	
} DMATRG_Type;  

typedef struct {                                /*!< (@ 0x40069000UL) TEST Structure                                              */
  __IOM uint32_t   TEST1;                        /*!< (@ 0x00000000) TEST1 register                             */
	__IM  uint32_t  RESERVED[2];
  __IOM uint32_t   LOCK;												/*!< (@ 0x00000004) LOCK register                             */
} TEST_Type;  
...
#define HALL                        ((HALL_Type*)               HALL_BASE)
#define DMA                         ((DMA_Type*)               DMA_BASE)
#define DMATRG                      ((DMATRG_Type*)            DMATRG_BASE)
...
#define CGC_CMC_OSCSEL1_Pos                (6UL)                     /*!< CGC CMC: OSCSEL (Bit 6)                               */
#define CGC_CMC_OSCSEL1_Msk                (0x40UL)                  /*!< CGC CMC: OSCSEL (Bitfield-Mask: 0x01)                 */
#define CGC_CMC_EXCLK0_Pos                 (7UL)                     /*!< CGC CMC: EXCLK (Bit 7)                                */
#define CGC_CMC_EXCLK0_Msk                 (0x80UL)                  /*!< CGC CMC: EXCLK (Bitfield-Mask: 0x01)                  */
/* ==========================================================  CSC  ========================================================== */
...
#define CGC_PER0_IICEN_Pos                (4UL)                     /*!< CGC PER0: IIC (Bit 0)                              */
#define CGC_PER0_IICEN_Msk                (0x10UL)                   /*!< CGC PER0: IIC (Bitfield-Mask: 0x01)                */
...
/* =======================================================  PLLCR  ======================================================== */
#define CGC_PLLCR_PLLON_Pos               (0UL)                     /*!< CGC PLL ENABLE (Bit 0)                         */
#define CGC_PLLCR_PLLON_Msk         		  (0x1UL)                   /*!< CGC PLL ENABLE (Bitfield-Mask: 0x01)           */
#define CGC_PLLCR_PLLP_Pos                (1UL)                     /*!< CGC PLL multip frequency (Bit 0)                         */
#define CGC_PLLCR_PLLP_Msk         		    (0x7UL<<CGC_PLLCR_PLLP_Pos)                   /*!< CGC PLL multip frequency (Bitfield-Mask: 0x01)           */
#define CGC_PLLCR_PLLCLKSEL_Pos           (7UL)                     /*!< CGC PLL clock select (Bit 0)                         */
#define CGC_PLLCR_PLLCLKSEL_Msk     		  (0x80UL)                  /*!< CGC PLL clock select (Bitfield-Mask: 0x01)           */
/* =======================================================  MCKC  ======================================================== */
#define CGC_MCKC_MCKSEL_Pos               (0UL)                     /*!< CGC system clock select (Bit 0)                         */
#define CGC_MCKC_MCKSEL_Msk         		  (0x1UL)                   /*!< CGC system clock select (Bitfield-Mask: 0x01)           */
#define CGC_MCKC_RDIV_Pos                 (1UL)                     /*!< CGC PLL DIV (Bit 0)                         */
#define CGC_MCKC_RDIV_Msk         		    (0x3UL<<CGC_MCKC_RDIV_Pos)                   /*!< CGC PLL DIV (Bitfield-Mask: 0x01)           */
#define CGC_MCKC_PLLCKSTR_Pos             (7UL)                     /*!< CGC system clock status (Bit 0)                         */
#define CGC_MCKC_PLLCKSTR_Msk         	  (0x80UL)                   /*!< CGC system clock status (Bitfield-Mask: 0x01)           */

/* =======================================================  PMUCTL  ======================================================== */
#define CGC_PMUCTL_PWDNEN_Pos               (0UL)                     /*!< CGC system power down select (Bit 0)                         */
#define CGC_PMUCTL_PWDNEN_Msk         		  (0x1UL)                   /*!< CGC system  power down select (Bitfield-Mask: 0x01)           */
/* ========================================================  HOCODIV  ======================================================== */
/* ========================================================  HIOTRM  ========================================================= */
/* ========================================================  PMUKEY  ========================================================= */
/* ========================================================  PMCCTL  ========================================================= */
...
/* ========================================================  P32CFG  ========================================================= */
#define PORT_P32CFG_CFG_Pos               (0UL)                     /*!< PORT P32CFG: CFG (Bit 0)                              */
#define PORT_P32CFG_CFG_Msk               (0xfUL)                   /*!< PORT P32CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P33CFG  ========================================================= */
#define PORT_P33CFG_CFG_Pos               (0UL)                     /*!< PORT P33CFG: CFG (Bit 0)                              */
#define PORT_P33CFG_CFG_Msk               (0xfUL)                   /*!< PORT P33CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P34CFG  ========================================================= */
#define PORT_P34CFG_CFG_Pos               (0UL)                     /*!< PORT P34CFG: CFG (Bit 0)                              */
#define PORT_P34CFG_CFG_Msk               (0xfUL)                   /*!< PORT P34CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P35CFG  ========================================================= */
#define PORT_P35CFG_CFG_Pos               (0UL)                     /*!< PORT P35CFG: CFG (Bit 0)                              */
#define PORT_P35CFG_CFG_Msk               (0xfUL)                   /*!< PORT P35CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P36CFG  ========================================================= */
#define PORT_P36CFG_CFG_Pos               (0UL)                     /*!< PORT P36CFG: CFG (Bit 0)                              */
#define PORT_P36CFG_CFG_Msk               (0xfUL)                   /*!< PORT P36CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P37CFG  ========================================================= */
#define PORT_P37CFG_CFG_Pos               (0UL)                     /*!< PORT P37CFG: CFG (Bit 0)                              */
#define PORT_P37CFG_CFG_Msk               (0xfUL)                   /*!< PORT P37CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P40CFG  ========================================================= */
...
/* ========================================================  P42CFG  ========================================================= */
#define PORT_P42CFG_CFG_Pos               (0UL)                     /*!< PORT P42CFG: CFG (Bit 0)                              */
#define PORT_P42CFG_CFG_Msk               (0xfUL)                   /*!< PORT P42CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P43CFG  ========================================================= */
#define PORT_P43CFG_CFG_Pos               (0UL)                     /*!< PORT P43CFG: CFG (Bit 0)                              */
#define PORT_P43CFG_CFG_Msk               (0xfUL)                   /*!< PORT P43CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P44CFG  ========================================================= */
#define PORT_P44CFG_CFG_Pos               (0UL)                     /*!< PORT P44CFG: CFG (Bit 0)                              */
#define PORT_P44CFG_CFG_Msk               (0xfUL)                   /*!< PORT P44CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P45CFG  ========================================================= */
#define PORT_P45CFG_CFG_Pos               (0UL)                     /*!< PORT P45CFG: CFG (Bit 0)                              */
#define PORT_P45CFG_CFG_Msk               (0xfUL)                   /*!< PORT P45CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P46CFG  ========================================================= */
#define PORT_P46CFG_CFG_Pos               (0UL)                     /*!< PORT P46CFG: CFG (Bit 0)                              */
#define PORT_P46CFG_CFG_Msk               (0xfUL)                   /*!< PORT P46CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P47CFG  ========================================================= */
#define PORT_P47CFG_CFG_Pos               (0UL)                     /*!< PORT P47CFG: CFG (Bit 0)                              */
#define PORT_P47CFG_CFG_Msk               (0xfUL)                   /*!< PORT P47CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P30CFG  ========================================================= */
#define PORT_P50CFG_CFG_Pos               (0UL)                     /*!< PORT P30CFG: CFG (Bit 0)                              */
#define PORT_P50CFG_CFG_Msk               (0xfUL)                   /*!< PORT P30CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P51CFG  ========================================================= */
#define PORT_P51CFG_CFG_Pos               (0UL)                     /*!< PORT P51CFG: CFG (Bit 0)                              */
#define PORT_P51CFG_CFG_Msk               (0xfUL)                   /*!< PORT P51CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P52CFG  ========================================================= */
#define PORT_P52CFG_CFG_Pos               (0UL)                     /*!< PORT P52CFG: CFG (Bit 0)                              */
#define PORT_P52CFG_CFG_Msk               (0xfUL)                   /*!< PORT P52CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P53CFG  ========================================================= */
#define PORT_P53CFG_CFG_Pos               (0UL)                     /*!< PORT P53CFG: CFG (Bit 0)                              */
#define PORT_P53CFG_CFG_Msk               (0xfUL)                   /*!< PORT P53CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P54CFG  ========================================================= */
#define PORT_P54CFG_CFG_Pos               (0UL)                     /*!< PORT P54CFG: CFG (Bit 0)                              */
#define PORT_P54CFG_CFG_Msk               (0xfUL)                   /*!< PORT P54CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P55CFG  ========================================================= */
#define PORT_P55CFG_CFG_Pos               (0UL)                     /*!< PORT P55CFG: CFG (Bit 0)                              */
#define PORT_P55CFG_CFG_Msk               (0xfUL)                   /*!< PORT P55CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P56CFG  ========================================================= */
#define PORT_P56CFG_CFG_Pos               (0UL)                     /*!< PORT P56CFG: CFG (Bit 0)                              */
#define PORT_P56CFG_CFG_Msk               (0xfUL)                   /*!< PORT P56CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  P57CFG  ========================================================= */
#define PORT_P57CFG_CFG_Pos               (0UL)                     /*!< PORT P57CFG: CFG (Bit 0)                              */
#define PORT_P57CFG_CFG_Msk               (0xfUL)                   /*!< PORT P57CFG: CFG (Bitfield-Mask: 0x0f)                */
/* ========================================================  INT0CFG  ======================================================== */
...
#define TM40_TMR00_CIS_Msk                (3<<TM40_TMR00_CIS_Pos)                  /*!< TM40 TMR00: CIS (Bitfield-Mask: 0x03)                 */
#define TM40_TMR00_STS_Pos                (8UL)                     /*!< TM40 TMR00: STS (Bit 8)                               */
#define TM40_TMR00_STS_Msk                (7<<TM40_TMR00_STS_Pos)                 /*!< TM40 TMR00: STS (Bitfield-Mask: 0x07)                 */
...
#define TMR_ICLR_ICLR_Msk			(0xffffffffUL<<TMR_ICLR_ICLR_Pos)
...
/* ========================================================  CLKPSC  ========================================================= */
#define	EPWM_CLKPSC_CLKPSC67_Pos		(24)
#define EPWM_CLKPSC_CLKPSC67_Msk		(0xffUL<<EPWM_CLKPSC_CLKPSC67_Pos)
...
/* ========================================================  CLKDIV  ========================================================= */
#define	EPWM_CLKDIV_CLKDIV7_Pos			(28)
#define EPWM_CLKDIV_CLKDIV7_Msk			(0x7UL<<EPWM_CLKDIV_CLKDIV7_Pos)
#define	EPWM_CLKDIV_CLKDIV6_Pos			(24)
#define EPWM_CLKDIV_CLKDIV6_Msk			(0x7UL<<EPWM_CLKDIV_CLKDIV6_Pos)
...
#define	EPWM_CON_ENDT67_Pos				(19)
#define EPWM_CON_ENDT67_Msk				(0x1UL<<EPWM_CON_ENDT67_Pos)
...
#define	EPWM_CON_PINV7_Pos				(15)
#define EPWM_CON_PINV7_Msk				(0x1UL<<EPWM_CON_PINV7_Pos)
#define	EPWM_CON_PINV6_Pos				(14)
#define EPWM_CON_PINV6_Msk				(0x1UL<<EPWM_CON_PINV6_Pos)
...
#define	EPWM_CON_CNTMODE7_Pos			(7)
#define EPWM_CON_CNTMODE7_Msk			(0x1UL<<EPWM_CON_CNTMODE7_Pos)
#define	EPWM_CON_CNTMODE6_Pos			(6)
#define EPWM_CON_CNTMODE6_Msk			(0x1UL<<EPWM_CON_CNTMODE6_Pos)
...
/* =========================================================  CON2  ========================================================== */
#define	EPWM_CON2_CNTEN7_Pos			(7)
#define EPWM_CON2_CNTEN7_Msk			(0x1UL<<EPWM_CON2_CNTEN7_Pos)
#define	EPWM_CON2_CNTEN6_Pos			(6)
#define EPWM_CON2_CNTEN6_Msk			(0x1UL<<EPWM_CON2_CNTEN6_Pos)
...
/* =========================================================  CON3  ========================================================== */
#define	EPWM_CON3_LOADTYP7_Pos			(30)
#define EPWM_CON3_LOADTYP7_Msk			(0x3UL<<EPWM_CON3_LOADTYP7_Pos)
#define	EPWM_CON3_LOADTYP6_Pos			(28)
#define EPWM_CON3_LOADTYP6_Msk			(0x3UL<<EPWM_CON3_LOADTYP6_Pos)
...
#define	EPWM_CON3_LOADEN7_Pos			(15)
#define EPWM_CON3_LOADEN7_Msk			(0x1UL<<EPWM_CON3_LOADEN7_Pos)
#define	EPWM_CON3_LOADEN6_Pos			(14)
#define EPWM_CON3_LOADEN6_Msk			(0x1UL<<EPWM_CON3_LOADEN6_Pos)
#define	EPWM_CON3_LOADEN5_Pos			(13)
#define EPWM_CON3_LOADEN5_Msk			(0x1UL<<EPWM_CON3_LOADEN5_Pos)
#define	EPWM_CON3_LOADEN4_Pos			(12)
#define EPWM_CON3_LOADEN4_Msk			(0x1UL<<EPWM_CON3_LOADEN4_Pos)
...
#define	EPWM_CON3_CNTCLR7_Pos			(7)
#define EPWM_CON3_CNTCLR7_Msk			(0x1UL<<EPWM_CON3_CNTCLR7_Pos)
#define	EPWM_CON3_CNTCLR6_Pos			(6)
#define EPWM_CON3_CNTCLR6_Msk			(0x1UL<<EPWM_CON3_CNTCLR6_Pos)
...
/* =========================================================  CON4  ========================================================== */
#define	EPWM_CON4_LOADNWINT_Pos			(3)
#define EPWM_CON4_LOADNWINT_Msk			(0x1UL<<EPWM_CON4_LOADNWINT_Pos)
#define	EPWM_CON4_LETGHALL_Pos			(2)
#define EPWM_CON4_LETGHALL_Msk			(0x1UL<<EPWM_CON4_LETGHALL_Pos)
#define	EPWM_CON4_LETGACMP1_Pos			(1)
#define EPWM_CON4_LETGACMP1_Msk			(0x1UL<<EPWM_CON4_LETGACMP1_Pos)
#define	EPWM_CON4_LETGACMP0_Pos			(0)
#define EPWM_CON4_LETGACMP0_Msk			(0x1UL<<EPWM_CON4_LETGACMP0_Pos)
...
/* ========================================================  CMPDAT5  ======================================================== */
/* ========================================================  POREMAP  ======================================================== */
#define	EPWM_POREMAP_PWMRMEN_Pos		(0)
#define EPWM_POREMAP_PWMRMEN_Msk		(0xffUL<<EPWM_POREMAP_PWMRMEN_Pos)
/* ========================================================  POREMAP  ======================================================== */
#define	EPWM_POREMAP_PWM7RM_Pos			(28)
#define EPWM_POREMAP_PWM7RM_Msk			(0x7UL<<EPWM_POREMAP_PWM7RM_Pos)
#define	EPWM_POREMAP_PWM6RM_Pos			(24)
#define EPWM_POREMAP_PWM6RM_Msk			(0x7UL<<EPWM_POREMAP_PWM6RM_Pos)
...
#define	EPWM_POEN_POEN7_Pos				(7)
#define EPWM_POEN_POEN7_Msk				(0x1UL<<EPWM_POEN_POEN7_Pos)
#define	EPWM_POEN_POEN6_Pos				(6)
#define EPWM_POEN_POEN6_Msk				(0x1UL<<EPWM_POEN_POEN6_Pos)
...
#define EPWM_BRKCTL_BRKODn_Msk			(0xffUL<<EPWM_BRKCTL_BRKODn_Pos)
/* =========================================================  DTCTL  ========================================================= */
#define	EPWM_DTCTL_DTI01R_Pos			(0)
#define EPWM_DTCTL_DTI01R_Msk			(0xFFFFUL<<EPWM_DTCTL_DTI01R_Pos)
#define	EPWM_DTCTL_DTI01L_Pos			(16)
#define EPWM_DTCTL_DTI01L_Msk			(0xFFFFUL<<EPWM_DTCTL_DTI01L_Pos)
/* =========================================================  MASK  ========================================================== */
#define	EPWM_MASK_MASKEN7_Pos			(15)
#define EPWM_MASK_MASKEN7_Msk			(0x1UL<<EPWM_MASK_MASKEN7_Pos)
#define	EPWM_MASK_MASKEN6_Pos			(14)
#define EPWM_MASK_MASKEN6_Msk			(0x1UL<<EPWM_MASK_MASKEN6_Pos)
...
#define	EPWM_MASK_MASKD7_Pos			(7)
#define EPWM_MASK_MASKD7_Msk			(0x1UL<<EPWM_MASK_MASKD7_Pos)
#define	EPWM_MASK_MASKD6_Pos			(6)
#define EPWM_MASK_MASKD6_Msk			(0x1UL<<EPWM_MASK_MASKD6_Pos)
...
#define	EPWM_MASKNXT_PMASKEN7_Pos		(15)
#define EPWM_MASKNXT_PMASKEN7_Msk		(0x1UL<<EPWM_MASKNXT_PMASKEN7_Pos)
#define	EPWM_MASKNXT_PMASKEN6_Pos		(14)
#define EPWM_MASKNXT_PMASKEN6_Msk		(0x1UL<<EPWM_MASKNXT_PMASKEN6_Pos)
...
#define	EPWM_MASKNXT_PMASKD7_Pos		(7)
#define EPWM_MASKNXT_PMASKD7_Msk		(0x1UL<<EPWM_MASKNXT_PMASKD7_Pos)
#define	EPWM_MASKNXT_PMASKD6_Pos		(6)
#define EPWM_MASKNXT_PMASKD6_Msk		(0x1UL<<EPWM_MASKNXT_PMASKD6_Pos)
...
#define EPWM_IMSC_ENDIFn_Msk			(0xffUL<<EPWM_IMSC_ENDIFn_Pos)
#define	EPWM_IMSC_ENUIFn_Pos			(16)
#define EPWM_IMSC_ENUIFn_Msk			(0xffUL<<EPWM_IMSC_ENUIFn_Pos)
#define	EPWM_IMSC_ENPIFn_Pos			(8)
#define EPWM_IMSC_ENPIFn_Msk			(0xffUL<<EPWM_IMSC_ENPIFn_Pos)
#define	EPWM_IMSC_ENZIFn_Pos			(0)
#define EPWM_IMSC_ENZIFn_Msk			(0xffUL<<EPWM_IMSC_ENZIFn_Pos)

/* =========================================================  IMSC2  ========================================================== */
#define	EPWM_IMSC2_ENBRKIF_Pos			(3)
#define EPWM_IMSC2_ENBRKIF_Msk			(0x1UL<<EPWM_IMSC2_ENBRKIF_Pos)
#define	EPWM_IMSC2_ENHALLIF_Pos			(2)
#define EPWM_IMSC2_ENHALLIF_Msk			(0x1UL<<EPWM_IMSC2_ENHALLIF_Pos)
#define	EPWM_IMSC2_ENDC1IF_Pos			(1)
#define EPWM_IMSC2_ENDC1IF_Msk			(0x1UL<<EPWM_IMSC2_ENDC1IF_Pos)
#define	EPWM_IMSC2_ENDC0IF_Pos			(0)
#define EPWM_IMSC2_ENDC0IF_Msk			(0x1UL<<EPWM_IMSC2_ENDC0IF_Pos)


/* ==========================================================  RIS  ========================================================== */
#define	EPWM_RIS_DIFn_Pos				(24)
#define EPWM_RIS_DIFn_Msk				(0xffUL<<EPWM_RIS_DIFn_Pos)	
#define	EPWM_RIS_UIFn_Pos				(16)
#define EPWM_RIS_UIFn_Msk				(0xffUL<<EPWM_RIS_UIFn_Pos)	
#define	EPWM_RIS_PIFn_Pos				(8)
#define EPWM_RIS_PIFn_Msk				(0xffUL<<EPWM_RIS_PIFn_Pos)	
#define	EPWM_RIS_ZIFn_Pos				(0)
#define EPWM_RIS_ZIFn_Msk				(0xffUL<<EPWM_RIS_ZIFn_Pos)
/* ==========================================================  RIS2  ========================================================== */
#define	EPWM_RIS2_BRKIF_Pos				(3)
#define EPWM_RIS2_BRKIF_Msk				(0x1UL<<EPWM_RIS2_BRKIF_Pos)
#define	EPWM_RIS2_HALLIF_Pos			(2)
#define EPWM_RIS2_HALLIF_Msk			(0x1UL<<EPWM_RIS2_HALLIF_Pos)
#define	EPWM_RIS2_DC1IF_Pos				(1)
#define EPWM_RIS2_DC1IF_Msk				(0x1UL<<EPWM_RIS2_DC1IF_Pos)	
#define	EPWM_RIS2_DC0IF_Pos				(0)
#define EPWM_RIS2_DC0IF_Msk				(0x1UL<<EPWM_RIS2_DC0IF_Pos)	

/* ==========================================================  MIS  ========================================================== */
#define	EPWM_MIS_DIFn_Pos				(24)
#define EPWM_MIS_DIFn_Msk				(0xffUL<<EPWM_MIS_DIFn_Pos)	
#define	EPWM_MIS_UIFn_Pos				(16)
#define EPWM_MIS_UIFn_Msk				(0xffUL<<EPWM_MIS_UIFn_Pos)		
#define	EPWM_MIS_PIFn_Pos				(8)
#define EPWM_MIS_PIFn_Msk				(0xffUL<<EPWM_MIS_PIFn_Pos)	
#define	EPWM_MIS_ZIFn_Pos				(0)
#define EPWM_MIS_ZIFn_Msk				(0xffUL<<EPWM_MIS_ZIFn_Pos)
/* ==========================================================  MIS2  ========================================================== */
#define	EPWM_MIS2_BRKIF_Pos				(3)
#define EPWM_MIS2_BRKIF_Msk				(0x1UL<<EPWM_MIS2_BRKIF_Pos)
#define	EPWM_MIS2_HALLIF_Pos				(2)
#define EPWM_MIS2_HALLIF_Msk				(0x1UL<<EPWM_MIS2_HALLIF_Pos)
#define	EPWM_MIS2_DC1IF_Pos				(1)
#define EPWM_MIS2_DC1IF_Msk				(0x1UL<<EPWM_MIS2_DC1IF_Pos)	
#define	EPWM_MIS2_DC0IF_Pos				(0)
#define EPWM_MIS2_DC0IF_Msk				(0x1UL<<EPWM_MIS2_DC0IF_Pos)
/* =========================================================  ICLR  ========================================================== */
#define	EPWM_ICLR_DIFn_Pos				(24)
#define EPWM_ICLR_DIFn_Msk				(0xffUL<<EPWM_ICLR_DIFn_Pos)	
#define	EPWM_ICLR_UIFn_Pos				(16)
#define EPWM_ICLR_UIFn_Msk				(0xffUL<<EPWM_ICLR_UIFn_Pos)	
#define	EPWM_ICLR_PIFn_Pos				(8)
#define EPWM_ICLR_PIFn_Msk				(0xffUL<<EPWM_ICLR_PIFn_Pos)	
#define	EPWM_ICLR_ZIFn_Pos				(0)
#define EPWM_ICLR_ZIFn_Msk				(0xffUL<<EPWM_ICLR_ZIFn_Pos)
/* =========================================================  ICLR2  ========================================================== */
#define	EPWM_ICLR2_BRKIF_Pos				(3)
#define EPWM_ICLR2_BRKIF_Msk				(0x1UL<<EPWM_ICLR2_BRKIF_Pos)
#define	EPWM_ICLR2_HALLIF_Pos			(2)
#define EPWM_ICLR2_HALLIF_Msk			(0x1UL<<EPWM_ICLR2_HALLIF_Pos)
#define	EPWM_ICLR2_DC1IF_Pos				(1)
#define EPWM_ICLR2_DC1IF_Msk				(0x1UL<<EPWM_ICLR2_DC1IF_Pos)	
#define	EPWM_ICLR2_DC0IF_Pos				(0)
#define EPWM_ICLR2_DC0IF_Msk				(0x1UL<<EPWM_ICLR2_DC0IF_Pos)	
/* ==========================================================  IFA  ========================================================== */
...
/* ========================================================  CCPCON1  ======================================================== */
#define	CCP_CCPCON1_CCP1PWM1AOP_Pos	(14)
#define CCP_CCPCON1_CCP1PWM1AOP_Msk	(0x1UL<<CCP_CCPCON1_CCP1PWM1AOP_Pos)
#define	CCP_CCPCON1_CCP1PWM1BOP_Pos	(13)
#define CCP_CCPCON1_CCP1PWM1BOP_Msk	(0x1UL<<CCP_CCPCON1_CCP1PWM1BOP_Pos)
#define	CCP_CCPCON1_CCP1RLOAD_Pos	(12)
#define CCP_CCPCON1_CCP1RLOAD_Msk	(0x1UL<<CCP_CCPCON1_CCP1RLOAD_Pos)
...
/* ========================================================  CFG ======================================================== */
#define	HALL_CFG_SWIE_Pos	(30)
#define HALL_CFG_SWIE_Msk	(0x1UL<<HALL_CFG_SWIE_Pos)
#define	HALL_CFG_OVIE_Pos	(29)
#define HALL_CFG_OVIE_Msk	(0x1UL<<HALL_CFG_OVIE_Pos)
#define	HALL_CFG_CHGIE_Pos	(28)
#define HALL_CFG_CHGIE_Msk	(0x1UL<<HALL_CFG_CHGIE_Pos)
#define	HALL_CFG_HALLEN_Pos	(24)
#define HALL_CFG_HALLEN_Msk	(0x1UL<<HALL_CFG_HALLEN_Pos)
#define	HALL_CFG_FIT75_Pos	(20)
#define HALL_CFG_FIT75_Msk	(0x1UL<<HALL_CFG_FIT75_Pos)
#define	HALL_CFG_CLKDIV_Pos	(16)
#define HALL_CFG_CLKDIV_Msk	(0x3UL<<HALL_CFG_CLKDIV_Pos)
#define	HALL_CFG_FITLEN_Pos	(0)
#define HALL_CFG_FITLEN_Msk	(0xFFFFUL<<HALL_CFG_FITLEN_Pos)
/* ========================================================  INFO ======================================================== */
#define	HALL_INFO_RAWDATA_Pos	(16)
#define HALL_INFO_RAWDATA_Msk	(0x7UL<<HALL_INFO_RAWDATA_Pos)
#define	HALL_INFO_FITDATA_Pos	(8)
#define HALL_INFO_FITDATA_Msk	(0x7UL<<HALL_INFO_FITDATA_Pos)
#define	HALL_INFO_OVIF_Pos	(1)
#define HALL_INFO_OVIF_Msk	(0x1UL<<HALL_INFO_OVIF_Pos)
#define	HALL_INFO_CHGIF_Pos	(0)
#define HALL_INFO_CHGIF_Msk	(0x1UL<<HALL_INFO_CHGIF_Pos)
/* ========================================================  INFO ======================================================== */
#define	HALL_CLRF_SETSWF_Pos	(16)
#define HALL_CLRF_SETSWF_Msk	(0x1UL<<HALL_CLRF_SETSWF_Pos)
#define	HALL_CLRF_CLROVF_Pos	(1)
#define HALL_CLRF_CLROVF_Msk	(0x1UL<<HALL_CLRF_CLROVF_Pos)
#define	HALL_CLRF_CLRCHGF_Pos	(0)
#define HALL_CLRF_CLRCHGF_Msk	(0x1UL<<HALL_CLRF_CLRCHGF_Pos)
...
#define ADC_CON_ADCDIV_Msk				(0x7UL<<ADC_CON_ADCDIV_Pos)

/* ========================================================  ADCCON2  ======================================================== */
#define	ADC_CON2_PGAHDEN_Pos			(23)
#define ADC_CON2_PGAHDEN_Msk			(0x1UL<<ADC_CON2_PGAHDEN_Pos)
#define	ADC_CON2_PGAHDTIM_Pos			(16)
#define ADC_CON2_PGAHDTIM_Msk			(0x3FUL<<ADC_CON2_PGAHDTIM_Pos)
...
/* ========================================================  ADCHWTG  ======================================================== */
#define	ADC_HWTG_ADCEPWMZEN_Pos			(31)
#define ADC_HWTG_ADCEPWMZEN_Msk			(0x1UL<<ADC_HWTG_ADCEPWMZEN_Pos)
#define	ADC_HWTG_ADCEPWMZSS_Pos			(28)
#define ADC_HWTG_ADCEPWMZSS_Msk			(0x7UL<<ADC_HWTG_ADCEPWMZSS_Pos)
#define	ADC_HWTG_ADCEPWMPEN_Pos			(27)
#define ADC_HWTG_ADCEPWMPEN_Msk			(0x1UL<<ADC_HWTG_ADCEPWMPEN_Pos)
#define	ADC_HWTG_ADCEPWMPSS_Pos			(24)
#define ADC_HWTG_ADCEPWMPSS_Msk			(0x7UL<<ADC_HWTG_ADCEPWMPSS_Pos)
#define	ADC_HWTG_ADCEPWMZDLEN_Pos			(21)
#define ADC_HWTG_ADCEPWMZDLEN_Msk			(0x1UL<<ADC_HWTG_ADCEPWMZDLEN_Pos)
#define	ADC_HWTG_ADCEPWMPDLEN_Pos			(20)
#define ADC_HWTG_ADCEPWMPDLEN_Msk			(0x1UL<<ADC_HWTG_ADCEPWMPDLEN_Pos)
...
/* ================                                            DAC                                            ================ */
/* =========================================================================================================================== */
#define	DAC_CON0_OEN2_Pos			 (17)
#define DAC_CON0_OEN2_Msk			(0x1UL<<DAC_CON0_OEN2_Pos)
#define	DAC_CON0_OEN1_Pos			 (16)
#define DAC_CON0_OEN1_Msk			(0x1UL<<DAC_CON0_OEN1_Pos)
...
/* =======================================================  PGA0CON0  ======================================================== */
#define	PGA0_CON_DRV_Pos					(18)
#define PGA0_CON_DRV_Msk					(0x1UL<<PGA0_CON_DRV_Pos)
#define	PGA0_CON_OTEN_Pos					(17)
#define PGA0_CON_OTEN_Msk					(0x1UL<<PGA0_CON_OTEN_Pos)
#define	PGA0_CON_OTSELR_Pos					(16)
#define PGA0_CON_OTSELR_Msk					(0x1UL<<PGA0_CON_OTSELR_Pos)
#define	PGA0_CON_EN_Pos					(12)
#define PGA0_CON_EN_Msk					(0x1UL<<PGA0_CON_EN_Pos)
#define	PGA0_CON_SWBTP_Pos					(11)
#define PGA0_CON_SWBTP_Msk					(0x1UL<<PGA0_CON_SWBTP_Pos)
#define	PGA0_CON_HOLD_Pos					(10)
#define PGA0_CON_HOLD_Msk					(0x1UL<<PGA0_CON_HOLD_Pos)
//#define	PGA0_CON_FBCMP_Pos					(9)
//#define PGA0_CON_FBCMP_Msk					(0x1UL<<PGA0_CON_FBCMP_Pos)
#define	PGA0_CON_VREF_Pos					(8)
#define PGA0_CON_VREF_Msk					(0x1UL<<PGA0_CON_VREF_Pos)
#define	PGA0_CON_BW_Pos					(4)
#define PGA0_CON_BW_Msk					(0x7UL<<PGA0_CON_BW_Pos)
#define	PGA0_CON_PS_Pos					(0)
#define PGA0_CON_PS_Msk					(0x7UL<<PGA0_CON_PS_Pos)

/* =======================================================  PGANCON0  ======================================================== */
//#define	PGAN_CON_PGA12SWSOFT_Pos					(16)
//#define PGAN_CON_PGA12SWSOFT_Msk					(0xFFFFUL<<PGAN_CON_PGA12SWSOFT_Pos)
#define	PGAN_CON_PGA2EN_Pos					(15)
#define PGAN_CON_PGA2EN_Msk					(0x1UL<<PGAN_CON_PGA2EN_Pos)
//#define	PGAN_CON_PGA2SWBTP_Pos					(13)
//#define PGAN_CON_PGA2SWBTP_Msk					(0x1UL<<PGAN_CON_PGA2SWBTP_Pos)
//#define	PGAN_CON_PGA2HOLD_Pos					(12)
//#define PGAN_CON_PGA2HOLD_Msk					(0x1UL<<PGAN_CON_PGA2HOLD_Pos)
#define	PGAN_CON_PGA2BW_Pos					(8)
#define PGAN_CON_PGA2BW_Msk					(0x7UL<<PGAN_CON_PGA2BW_Pos)
#define	PGAN_CON_PGA1EN_Pos					(7)
#define PGAN_CON_PGA1EN_Msk					(0x1UL<<PGAN_CON_PGA1EN_Pos)
//#define	PGAN_CON_PGA1SWBTP_Pos					(5)
//#define PGAN_CON_PGA1SWBTP_Msk					(0x1UL<<PGAN_CON_PGA1SWBTP_Pos)
//#define	PGAN_CON_PGA1HOLD_Pos					(4)
//#define PGAN_CON_PGA1HOLD_Msk					(0x1UL<<PGAN_CON_PGA1HOLD_Pos)
#define	PGAN_CON_PGA1BW_Pos					(0)
#define PGAN_CON_PGA1BW_Msk					(0x7UL<<PGAN_CON_PGA1BW_Pos)

/* =======================================================  PGANCON1  ======================================================== */
//#define	PGAN_CON_PGA3SWSOFT_Pos					(16)
//#define PGAN_CON_PGA3SWSOFT_Msk					(0xFFFFUL<<PGAN_CON_PGA3SWSOFT_Pos)
#define	PGAN_CON_PGA123DRV_Pos					(13)
#define PGAN_CON_PGA123DRV_Msk					(0x1UL<<PGAN_CON_PGA123DRV_Pos)
//#define	PGAN_CON_PGA123FBCNP_Pos					(12)
//#define PGAN_CON_PGA123FBCNP_Msk					(0x1UL<<PGAN_CON_PGA123FBCNP_Pos)
#define	PGAN_CON_PGA123S_Pos					(8)
#define PGAN_CON_PGA123S_Msk					(0x7UL<<PGAN_CON_PGA123S_Pos)
#define	PGAN_CON_PGA3EN_Pos					(7)
#define PGAN_CON_PGA3EN_Msk					(0x1UL<<PGAN_CON_PGA3EN_Pos)
//#define	PGAN_CON_PGA3SWBTP_Pos					(5)
//#define PGAN_CON_PGA3SWBTP_Msk					(0x1UL<<PGAN_CON_PGA3SWBTP_Pos)
//#define	PGAN_CON_PGA3HOLD_Pos					(4)
//#define PGAN_CON_PGA3HOLD_Msk					(0x1UL<<PGAN_CON_PGA3HOLD_Pos)
#define	PGAN_CON_PGA3BW_Pos					(0)
#define PGAN_CON_PGA3BW_Msk					(0x7UL<<PGAN_CON_PGA3BW_Pos)

/* =======================================================  PGANSW  ======================================================== */
//#define	PGAN_CON_PGA123SWSEL_Pos					(16)
//#define PGAN_CON_PGA123SWSEL_Msk					(0xFFFFUL<<PGAN_CON_PGA123SWSEL_Pos)
#define	PGAN_CON_PGA3IOEN_Pos					(10)
#define PGAN_CON_PGA3IOEN_Msk					(0x1UL<<PGAN_CON_PGA3IOEN_Pos)
#define	PGAN_CON_PGA2IOEN_Pos					(9)
#define PGAN_CON_PGA2IOEN_Msk					(0x1UL<<PGAN_CON_PGA2IOEN_Pos)
#define	PGAN_CON_PGA1IOEN_Pos					(8)
#define PGAN_CON_PGA1IOEN_Msk					(0x1UL<<PGAN_CON_PGA1IOEN_Pos)
//#define	PGAN_CON_PGA123W_Pos					(0)
//#define PGAN_CON_PGA123SW_Msk					(0x3UL<<PGAN_CON_PGA123SW_Pos)
...
#define ACMP_C0CON0_NS_Msk					(0x7UL<<ACMP_C0CON0_NS_Pos)
/* ========================================================  C0CON1  ========================================================= */
...
/* ========================================================  C0ADJE  ========================================================= */
/* ========================================================  C1CON0  ========================================================= */
#define	ACMP_C1CON0_ZXD_Pos					(16)
#define ACMP_C1CON0_ZXD_Msk					(0x1UL<<ACMP_C1CON0_ZXD_Pos)
...
#define ACMP_C1CON0_NS_Msk					(0x7UL<<ACMP_C1CON0_NS_Pos)
/* ========================================================  C1CON1  ========================================================= */
...
#define ACMP_C1CON1_FS_Msk					(0xFUL<<ACMP_C1CON1_FS_Pos)
/* ========================================================  C1CON2  ========================================================= */
...
/* =========================================================  IMSC  ========================================================== */
#define	ACMP_IMSC_C1LIF_Pos					(6)
#define ACMP_IMSC_C1LIF_Msk					(0x1UL<<ACMP_IMSC_C1LIF_Pos)
#define	ACMP_IMSC_C1HIF_Pos					(5)
#define ACMP_IMSC_C1HIF_Msk					(0x1UL<<ACMP_IMSC_C1HIF_Pos)
#define	ACMP_IMSC_C1IF_Pos					(4)
#define ACMP_IMSC_C1IF_Msk					(0x1UL<<ACMP_IMSC_C1IF_Pos)
#define	ACMP_IMSC_C0LIF_Pos					(2)
#define ACMP_IMSC_C0LIF_Msk					(0x1UL<<ACMP_IMSC_C0LIF_Pos)
#define	ACMP_IMSC_C0HIF_Pos					(1)
#define ACMP_IMSC_C0HIF_Msk					(0x1UL<<ACMP_IMSC_C0HIF_Pos)
#define	ACMP_IMSC_C0IF_Pos					(0)
#define ACMP_IMSC_C0IF_Msk					(0x1UL<<ACMP_IMSC_C0IF_Pos)
/* ==========================================================  RIS  ========================================================== */
#define	ACMP_RIS_C1LIF_Pos					(6)
#define ACMP_RIS_C1LIF_Msk					(0x1UL<<ACMP_RIS_C1LIF_Pos)
#define	ACMP_RIS_C1HIF_Pos					(5)
#define ACMP_RIS_C1HIF_Msk					(0x1UL<<ACMP_RIS_C1HIF_Pos)
#define	ACMP_RIS_C1IF_Pos					(4)
#define ACMP_RIS_C1IF_Msk					(0x1UL<<ACMP_RIS_C1IF_Pos)
#define	ACMP_RIS_C0LIF_Pos					(2)
#define ACMP_RIS_C0LIF_Msk					(0x1UL<<ACMP_RIS_C0LIF_Pos)
#define	ACMP_RIS_C0HIF_Pos					(1)
#define ACMP_RIS_C0HIF_Msk					(0x1UL<<ACMP_RIS_C0HIF_Pos)
#define	ACMP_RIS_C0IF_Pos					(0)
#define ACMP_RIS_C0IF_Msk					(0x1UL<<ACMP_RIS_C0IF_Pos)
/* ==========================================================  MIS  ========================================================== */
#define	ACMP_MIS_C1LIF_Pos					(6)
#define ACMP_MIS_C1LIF_Msk					(0x1UL<<ACMP_MIS_C1LIF_Pos)
#define	ACMP_MIS_C1HIF_Pos					(5)
#define ACMP_MIS_C1HIF_Msk					(0x1UL<<ACMP_MIS_C1HIF_Pos)
#define	ACMP_MIS_C1IF_Pos					(4)
#define ACMP_MIS_C1IF_Msk					(0x1UL<<ACMP_MIS_C1IF_Pos)
#define	ACMP_MIS_C0LIF_Pos					(2)
#define ACMP_MIS_C0LIF_Msk					(0x1UL<<ACMP_MIS_C0LIF_Pos)
#define	ACMP_MIS_C0HIF_Pos					(1)
#define ACMP_MIS_C0HIF_Msk					(0x1UL<<ACMP_MIS_C0HIF_Pos)
#define	ACMP_MIS_C0IF_Pos					(0)
#define ACMP_MIS_C0IF_Msk					(0x1UL<<ACMP_MIS_C0IF_Pos)
/* =========================================================  ICLR  ========================================================== */
#define	ACMP_ICLR_C1LIF_Pos					(6)
#define ACMP_ICLR_C1LIF_Msk					(0x1UL<<ACMP_ICLR_C1LIF_Pos)
#define	ACMP_ICLR_C1HIF_Pos					(5)
#define ACMP_ICLR_C1HIF_Msk					(0x1UL<<ACMP_ICLR_C1HIF_Pos)
#define	ACMP_ICLR_C1IF_Pos					(4)
#define ACMP_ICLR_C1IF_Msk					(0x1UL<<ACMP_ICLR_C1IF_Pos)
#define	ACMP_ICLR_C0LIF_Pos					(2)
#define ACMP_ICLR_C0LIF_Msk					(0x1UL<<ACMP_ICLR_C0LIF_Pos)
#define	ACMP_ICLR_C0HF_Pos					(1)
#define ACMP_ICLR_C0HIF_Msk					(0x1UL<<ACMP_ICLR_C0HIF_Pos)
...
/* ==========================================================  TIOS0  ========================================================== */
#define MISC_TIOS0_TIS00_Pos               (0UL)                     /*!< MISC TIOS0: TIS00 (Bit x)                              */
#define MISC_TIOS0_TIS00_Msk               (0x01UL)                  /*!< MISC TIOS0: TIS00 (Bitfield-Mask: 0x01)                */
#define MISC_TIOS0_TIS01_Pos               (1UL)                     /*!< MISC TIOS0: TIS01 (Bit x)                              */
#define MISC_TIOS0_TIS01_Msk               (0x02UL)                  /*!< MISC TIOS0: TIS01 (Bitfield-Mask: 0x01)                */
#define MISC_TIOS0_TIS02_Pos               (2UL)                     /*!< MISC TIOS0: TIS02 (Bit x)                              */
#define MISC_TIOS0_TIS02_Msk               (0x04UL)                  /*!< MISC TIOS0: TIS02 (Bitfield-Mask: 0x01)                */
#define MISC_TIOS0_TOS03_Pos               (3UL)                     /*!< MISC TIOS0: TIS00 (Bit x)                              */
#define MISC_TIOS0_TOS03_Msk               (0x08UL)                  /*!< MISC TIOS0: TIS00 (Bitfield-Mask: 0x01)                */
#define MISC_TIOS0_TIS04_Pos               (4UL)                     /*!< MISC TIOS0: TIS00 (Bit x)                              */
#define MISC_TIOS0_TIS04_Msk               (0x10UL)                  /*!< MISC TIOS0: TIS00 (Bitfield-Mask: 0x01)                */
#define MISC_TIOS0_TIS05_Pos               (5UL)                     /*!< MISC TIOS0: TIS00 (Bit x)                              */
#define MISC_TIOS0_TIS05_Msk               (0x20UL)                  /*!< MISC TIOS0: TIS00 (Bitfield-Mask: 0x01)                */
#define MISC_TIOS0_TIS06_Pos               (6UL)                     /*!< MISC TIOS0: TIS00 (Bit x)                              */
#define MISC_TIOS0_TIS06_Msk               (0x40UL)                  /*!< MISC TIOS0: TIS00 (Bitfield-Mask: 0x01)                */
#define MISC_TIOS0_TIS07_Pos               (7UL)                     /*!< MISC TIOS0: TIS00 (Bit x)                              */
#define MISC_TIOS0_TIS07_Msk               (0x80UL)                  /*!< MISC TIOS0: TIS00 (Bitfield-Mask: 0x01)                */
...
#define SAF_CRC0CTL_FEA_Msk               (0x3FUL)                  /*!< SAF CRC0CTL: FEA (Bitfield-Mask: 0x7f)                */
/* ========================================================  PGCRCL  ========================================================= */
/* =========================================================  CRCIN  ========================================================= */
/* =========================================================  CRCD  ========================================================== */
/* ========================================================  RPECTL  ========================================================= */
...
/* =======================================================  TEST1  ======================================================= */
#define TEST_TEST1_PGA123OEN_Pos           (2UL)                    /*!< TEST1 PGA123_OEN: PGA out to P50 (Bit 2)              */
#define TEST_TEST1_PGA123OEN_Msk           (0x4UL)                  /*!< TEST1 PGA123_OEN: OEN (Bitfield-Mask: 0x04)           */
