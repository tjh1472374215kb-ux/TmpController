/**************************************************************************//**
 * @file     system_CMS32M67xx.c
 * @brief    CMSIS Cortex-M0 Device Peripheral Access Layer Source File
 *           for the CMS CMS32M67xx Series
 * @version  V2.10
 * @date     20. July 2011
 *
 * @note
...
#define HSI_72M_VAL 72000000
#define RC_40K_VAL  15000
...
typedef enum {
  HOCO_FREQ_72MHZ = 0xF0, 	/*!< fHOCO = 72MHz, fIH = 72MHz  	*/
  HOCO_FREQ_36MHZ = 0xF1, 	/*!< fHOCO = 72MHz, fIH = 36MHz  	*/
  HOCO_FREQ_18MHZ = 0xF2, 	/*!< fHOCO = 72MHz, fIH = 18MHz  	*/
  HOCO_FREQ_9MHZ = 0xF3, 	/*!< fHOCO = 72MHz, fIH = 9MHz  	*/
  HOCO_FREQ_4P5MHZ = 0xF4, 	/*!< fHOCO = 72MHz, fIH = 4.5MHz  	*/
  HOCO_FREQ_64MHZ = 0xE0, 	/*!< fHOCO = 64MHz, fIH = 64MHz  	*/
  HOCO_FREQ_32MHZ  = 0xE1, 	/*!< fHOCO = 64MHz, fIH = 32MHz  	*/
  HOCO_FREQ_16MHZ  = 0xE2, 	/*!< fHOCO = 64MHz, fIH =  16MHz  	*/
  HOCO_FREQ_8MHZ  = 0xE3, 	/*!< fHOCO = 64MHz, fIH =  8MHz  	*/
  HOCO_FREQ_4MHZ  = 0xE4, 	/*!< fHOCO = 64MHz, fIH =  4MHz  	*/
  HOCO_FREQ_2MHZ  = 0xE5, 	/*!< fHOCO = 64MHz, fIH =  2MHz   	*/
} hoco_freq_t;
...
//     <o.5..6> Watchdog timer window open period setting      <2=> 75%        
//     <o.1..3> Watchdog timer overflow time setting           <0=> 2^6/fIL    
//                                                             <1=> 2^7/fIL 
//                                                             <2=> 2^8/fIL 
//                                                             <3=> 2^9/fIL 	
//                                                             <4=> 2^11/fIL
...
//                                                          <0xE0=> fHOCO = 64MHz, fIH = 64MHz
//                                                          <0xE1=> fHOCO = 64MHz, fIH = 32MHz
//                                                          <0xE2=> fHOCO = 64MHz, fIH =  16MHz
//                                                          <0xE3=> fHOCO = 64MHz, fIH =  8MHz
...
uint32_t CLK_GetHocoFreq(void)
{
  ...
  switch(frqsel)
  {
      case HOCO_FREQ_72MHZ: 
          freq = 72000000U; 	/* fIH = 72MHz 	*/
          break;
      case HOCO_FREQ_36MHZ: 
          freq = 36000000U; 	/* fIH = 36MHz 	*/
          break;
      case HOCO_FREQ_18MHZ: 
          freq = 18000000U; 	/* fIH = 18MHz 	*/
          break;
      case HOCO_FREQ_9MHZ: 
          freq = 9000000U; 	/* fIH = 9MHz 	*/
          break;
      case HOCO_FREQ_4P5MHZ: 
          freq = 4500000U; 	/* fIH = 4.5MHz 	*/
          break;
