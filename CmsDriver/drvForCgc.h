...
/*
    Oscillation pin control register (CMC) 
*/
/* oscillator clock operation control (HIOSTOP) */
#define _00_CMC_OSCSEL_PORT                           (0x00U) /* oscillator pin as normal pin */
#define _01_CMC_OSCSEL_X1                             (0x01U) /* oscillator pin as X1 pin */
#define _03_CMC_OSCSEL_CLKIN                          (0x03U) /* oscillator pin as External clock input pin */
...
#define CGC_MCLK_FIH           (0x00U) /* system main clock select FIH */
#define CGC_MCLK_PLL           (0x01U) /* system main clock select PLL */
/***********************************************************************************************************************
Macro definitions
***********************************************************************************************************************/
